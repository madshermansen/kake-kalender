    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-6xl px-5 py-8 sm:px-8 lg:py-12">
        ...
        <div className="flex flex-col gap-8">
          <section className="order-3 w-full rounded-2xl border border-border bg-card p-4 shadow-sm sm:p-5 lg:order-3 lg:max-w-4xl lg:self-center">
          ...
          <aside className="order-4 flex flex-col gap-8 lg:order-4 lg:grid lg:grid-cols-2 lg:items-start">
