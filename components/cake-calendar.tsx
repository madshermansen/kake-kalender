...
export function CakeCalendar({ initialEvents, initialSuggestions, isAdmin }: { initialEvents: CakeEvent[]; initialSuggestions: CakeSuggestion[]; isAdmin: boolean }) {
  ...
  const [activeTab, setActiveTab] = useState<'leaderboard' | 'suggestions'>('leaderboard')
    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-6xl px-5 py-8 sm:px-8 lg:py-12">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.35fr)_minmax(280px,0.65fr)] lg:items-start">
          <section className="order-1 w-full rounded-2xl border border-border bg-card p-4 shadow-sm sm:p-5">
