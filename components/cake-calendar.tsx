  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-6xl px-5 py-8 sm:px-8 lg:py-12">
        <nav className="mb-8 flex w-full items-center gap-6 border-b border-border pb-3" aria-label="Cake calendar pages"><Link href="/" className={`text-sm font-bold transition ${page === 'calendar' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}>Calendar</Link><Link href="/leaderboard" className={`text-sm font-bold transition ${page === 'leaderboard' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}>Leaderboard</Link><Link href="/suggestions" className={`text-sm font-bold transition ${page === 'suggestions' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}>Suggestions</Link></nav>
